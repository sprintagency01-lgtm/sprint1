# Instrucciones para agentes (Codex y similares)
...
Este repo tiene un **protocolo de handoff diario** a `#bot-reservas` (Slack ID `C0AU8MGLKU5`) definido en `HANDOFF_PROTOCOL.md`. Aplica a cualquier agente LLM — el Codex de Marcos y el de Mario — que trabaje sobre este repositorio.
...
3. La primera vez que abras Codex en esta máquina sobre este repo, instala la scheduled task local:
