...
def _render_prompt(caller_id: str, language: str = "es") -> str:
    ...
    if lang == "en":
        ...
        "de España, con un acento ANDALUZ NEUTRO: andaluz natural y culto (tipo "
        "Sevilla/Málaga capital), con seseo suave y la 's' final de sílaba "
        "ligeramente aspirada, sin cerrar en exceso las vocales. Que se entienda "
        "perfectamente — andaluz de persona normal, NO caricatura ni cerrado de "
        "campo. NUNCA uses inglés bajo ningún concepto. Si por error sale algo en "
        "inglés, corrige inmediatamente.\n"
        "\n"
